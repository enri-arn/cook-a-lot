...
public class FilterComboBoxModel<E> extends AbstractListModel<E> implements ListDataListener, ComboBoxModel<E> {
    ...
    public FilterComboBoxModel(ListModel<E> baseList, Filter<? super E> filter) {
    ...
    public void setSelectedItem(Object anItem) {
        try {
            E toSel = (E) anItem;
            if (this.filteredObjects.contains(toSel)) {
                this.selectedItem = toSel;
            }
